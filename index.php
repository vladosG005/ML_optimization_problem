    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                ?>
                    <td class="value"><?= "{$targetModel} {$targetDataset}"?><?= shell_exec("/opt/rh/rh-python313/root/usr/bin/python -W ignore ./python_benchmark/get_time.py {$targetModel} {$targetDataset}") ?></td>
